function General_bin_movement_and_transition_local_linux(transition_loops,voronoi_loops,temporary_save_location,target_bin_number,Replicas_per_bins,output_file_name,tau,species,output_save_file,BNG_root,model_name,vor_inp)
...
VoronoiCenters = load(vor_inp);
target_bin_number = length(VoronoiCenters);
...
%%removed Voronoi calculation loop
