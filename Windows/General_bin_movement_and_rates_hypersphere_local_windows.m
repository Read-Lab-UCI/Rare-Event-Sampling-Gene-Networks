function General_bin_movement_and_rates_hypersphere_local_windows(transition_rate_loops,temporary_save_location,Replicas_per_bins,output_file_name,tau,species,output_save_file,BNG_root,model_name,original_voronoi_center,regionradius,region1,region2)
