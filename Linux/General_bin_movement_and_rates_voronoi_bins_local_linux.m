function General_bin_movement_and_rates_voronoi_bins_local_linux(transition_rate_loops,temporary_save_location,Replicas_per_bins,output_file_name,tau,species,output_save_file,BNG_root,model_name,original_voronoi_center,mapping_centers,region1,region2)
    ...
    % loading the information for input regions of interest for the rate
    ...
    % Specifies if a given replica was previously in region1 (denoted as 1) or in region2 (denoted as -1)
    ...
    %% Step 2: Perform WEstep on the replicas and declare containers
    ...
    %% Step 3: Calculating the transition matrix
